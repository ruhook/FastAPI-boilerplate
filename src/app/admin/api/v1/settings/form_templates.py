...
@router.get("", response_model=list[FormTemplateRead], dependencies=[Depends(require_admin_permission("报名表单策略"))])
...
@router.get("/{template_id}", response_model=FormTemplateRead, dependencies=[Depends(require_admin_permission("报名表单策略"))])

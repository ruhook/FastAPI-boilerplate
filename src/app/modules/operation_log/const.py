...
class OperationLogType(StrEnum):
    ...
    JOB_PROGRESS_QA_REVIEW_UPDATED = "job_progress_qa_review_updated"
    JOB_PROGRESS_NOTE_UPDATED = "job_progress_note_updated"
    JOB_PROGRESS_CONTRACT_RECORD_UPDATED = "job_progress_contract_record_updated"
    ...
    JOB_PROGRESS_STAGE_MAIL_TASK_CREATED = "job_progress_stage_mail_task_created"

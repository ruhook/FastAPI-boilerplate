...
from .const import JOB_STATUS_OPTIONS, JOB_WORK_MODE_OPTIONS
...
class JobBase(BaseModel):
    ...
    status: str = Field(default=JOB_STATUS_OPTIONS[0], min_length=1, max_length=20)
    work_mode: str = Field(default=JOB_WORK_MODE_OPTIONS[0], min_length=1, max_length=20)
    ...
    def validate_status(cls, value: str) -> str:
        ...
        if normalized not in JOB_STATUS_OPTIONS:
    ...
    def validate_work_mode(cls, value: str) -> str:
        normalized = _normalize_text(value)
        if normalized not in JOB_WORK_MODE_OPTIONS:

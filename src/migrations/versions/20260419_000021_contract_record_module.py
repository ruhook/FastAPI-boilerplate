...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("legal_entity", sa.String(length=120), nullable=False, server_default=sa.text("'T-Maxx International'")),
    ...
    op.create_index(op.f("ix_contract_record_user_snapshot_name"), "contract_record", ["user_snapshot_name"], unique=False)
    op.create_index(op.f("ix_contract_record_user_snapshot_email"), "contract_record", ["user_snapshot_email"], unique=False)
    op.create_index(op.f("ix_contract_record_talent_profile_id"), "contract_record", ["talent_profile_id"], unique=False)
    ...
    op.create_index(op.f("ix_contract_record_job_snapshot_title"), "contract_record", ["job_snapshot_title"], unique=False)
    op.create_index(op.f("ix_contract_record_service_customer_company_id"), "contract_record", ["service_customer_company_id"], unique=False)
    op.create_index(op.f("ix_contract_record_service_customer_company_name"), "contract_record", ["service_customer_company_name"], unique=False)
    ...
    op.create_index(op.f("ix_contract_record_draft_contract_asset_id"), "contract_record", ["draft_contract_asset_id"], unique=False)
    op.create_index(op.f("ix_contract_record_candidate_signed_contract_asset_id"), "contract_record", ["candidate_signed_contract_asset_id"], unique=False)
    op.create_index(op.f("ix_contract_record_company_sealed_contract_asset_id"), "contract_record", ["company_sealed_contract_asset_id"], unique=False)
    op.create_index(op.f("ix_contract_record_contract_attachment_asset_id"), "contract_record", ["contract_attachment_asset_id"], unique=False)
    ...
    op.create_index(op.f("ix_contract_record_created_by_admin_user_id"), "contract_record", ["created_by_admin_user_id"], unique=False)
    op.create_index(op.f("ix_contract_record_updated_by_admin_user_id"), "contract_record", ["updated_by_admin_user_id"], unique=False)

...
async def ensure_candidate_resume_asset(
    ...
    *,
    ...
    content = (f"Advanced filter bulk demo resume for {email}\nGenerated by run_advanced_filter_bulk_demo.py\n").encode()
...
async def main() -> None:
    ...
    print_detail(
        f"progress seeded={len(progress_rows)} screening_match={actual_progress_screening} contract_match={actual_progress_contract}"
    )
